...
const translations = {
  en: {
    ...
    text: [
      ...
      { selector: '#success-story .section-kicker', value: 'Client Success Story' },
      { selector: '#success-story h2', value: 'From outdated and difficult to manage to a polished, lead-generating website.' },
      { selector: '#success-story .lead', value: 'Juan A1 Custom Countertops LLC came to us with a clear problem: their website didn’t reflect the quality of their craftsmanship and couldn’t be updated easily.' },
      { selector: '#success-story .lead + p', value: 'There was no real brand identity, the site was not mobile responsive, it was slow, and their previous marketer was unreachable for edits. They needed a more professional online presence that could support growth and help them reach more clients.' },
      { selector: '#success-story .lead + p + p', value: 'We rebuilt the website from the ground up, created a custom logo to give their company stronger identity, added a custom domain with the LLC, improved their sales process with a quote request form, and expanded their online capabilities with an eCommerce store, invoicing support, business email, and professionally branded business cards.' },
      { selector: '#success-story blockquote', value: '“Solid Site did a great job on rebuilding my old website and making us look more professional. They also provided all the training for how to use our new software.”' },
      { selector: '#success-story .client-name', value: '— Juan A1 Custom Countertops LLC' },
      { selector: '#success-story .success-story-link', value: 'Visit the live website →' },
  ...
  es: {
    ...
    text: [
      ...
      { selector: '#success-story .section-kicker', value: 'Historia de éxito del cliente' },
      { selector: '#success-story h2', value: 'De un sitio desactualizado y difícil de administrar a una presencia profesional y generadora de leads.' },
      { selector: '#success-story .lead', value: 'Juan A1 Custom Countertops LLC llegó a nosotros con un problema claro: su sitio web no reflejaba la calidad de su trabajo y no podía actualizarse fácilmente.' },
      { selector: '#success-story .lead + p', value: 'No había una identidad de marca real, el sitio no era compatible con móviles, era lento y el especialista anterior no estaba disponible para hacer cambios. Necesitaban una presencia en línea más profesional que apoyara el crecimiento y les ayudara a llegar a más clientes.' },
      { selector: '#success-story .lead + p + p', value: 'Reconstruimos el sitio desde cero, creamos un logotipo personalizado para fortalecer la identidad de su empresa, agregamos un dominio con la LLC, mejoramos su proceso de ventas con un formulario de cotización y ampliamos sus capacidades en línea con una tienda en línea, soporte de facturación, correo corporativo y tarjetas de presentación profesionales.' },
      { selector: '#success-story blockquote', value: '“Solid Site hizo un excelente trabajo reconstruyendo mi sitio web antiguo y dándonos una imagen más profesional. También nos brindaron toda la capacitación para usar nuestro nuevo software.”' },
      { selector: '#success-story .client-name', value: '— Juan A1 Custom Countertops LLC' },
      { selector: '#success-story .success-story-link', value: 'Ver el sitio web en vivo →' },
